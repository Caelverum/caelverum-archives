  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <section className="relative h-[70vh] min-h-[520px] flex items-center overflow-hidden">
        {/* Background gradient (temporary until we add the real cinematic image) */}
        <div className="absolute inset-0 bg-gradient-to-r from-zinc-950 via-zinc-900 to-zinc-800"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-sm tracking-[0.25em] text-zinc-400 mt-6 uppercase">
              Timeless insights for a complex world
            </p>

            <button className="mt-10 border border-amber-500/70 hover:bg-amber-500 hover:text-black text-amber-400 px-8 py-3.5 rounded text-sm tracking-wider transition-all">
              EXPLORE ARCHIVES
            </button>
          </div>
        </div>
      ...
      {/* ===== LATEST ARTICLES (Netflix-style horizontal row) ===== */}
      ...
      {/* ===== CATEGORY ROWS (placeholder structure for future growth) ===== */}
      <section className="pb-20">
        <div className="max-w-7xl mx-auto px-6 space-y-14">
          {/* Example category row – Human Behaviour */}
          <div>
